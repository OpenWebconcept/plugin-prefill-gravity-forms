...
/**
 * Controller for the WeAreFrank! BRP supplier.
 *
 * @since 1.6.0
 */
class WeAreFrankController extends PostController
{
	...
	public function handle(array $form ): array
	{
		...
		$first_person     = $this->fetch_api_response( $bsn, $expand, $goal_binding, $processing, $exclude_deceased );
		...
		return $this->pre_fill_fields( $form, $first_person );
	}
