...
class PinkRoccadeV2Controller extends BaseController
{
    public function handle(array $form): array
    {
        ...
        $apiResponse = $this->fetchApiResponse($preparedData, $doelBinding);
    ...
    protected function fetchApiResponse(array $preparedData, string $doelBinding): array
    {
        $apiResponse = $this->request($preparedData, $doelBinding);
    ...
    protected function request(array $data, string $doelBinding): array
    {
        $curlArgs = [
            ...
            CURLOPT_HTTPHEADER => [
                ...
                'x-verwerking' => $this->settings->getProcessing(),
